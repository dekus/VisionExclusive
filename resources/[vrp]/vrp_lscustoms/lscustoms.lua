...
local garages = {
	[1] = { locked = false, camera = { x = -1155.41, y = -2007.84, z = 13.19, heading = 339.00 }, driveout = { x = -1155.41, y = -2007.84, z = 13.19, heading = 339.00 }, drivein = { x = -1155.41, y = -2007.84, z = 13.19, heading = 339.00 }, outside = { x = -1155.41, y = -2007.84, z = 13.19, heading = 339.00 }, inside = { x = -1155.41, y = -2007.84, z = 13.19, heading = 339.00 }},
	[2] = { locked = false, camera = { x = -1157.59, y = -2022.25, z = 13.13, heading =  273.54}, driveout = { x = -1157.59, y = -2022.25, z = 13.13, heading =  273.54}, drivein = { x = -1157.59, y = -2022.25, z = 13.13, heading =  273.54}, outside = { x = -1157.59, y = -2022.25, z = 13.13, heading =  273.54}, inside = { x = -1157.59, y = -2022.25, z = 13.13, heading =  273.54}}
}

local disableControls = false
local function disableControlsFunc(toogle)
	toogle = not toogle
    if disableControls == toogle then return end
    disableControls = toogle
...
local LSCMenu = Menu.new("Bennys","categorie",0.16,0.13,0.24,0.36,0,{255,255,255,255})
...
local function DriveInGarage()
	...
	if DoesEntityExist(veh) then
		...
		SetIbuttons({
			{GetControlInstructionalButton(1,LSCMenu.config.controls.menu_back, 0),"Tornare indietro"},
			{GetControlInstructionalButton(1,LSCMenu.config.controls.menu_select, 0),"Selezionare"},
			{GetControlInstructionalButton(1,LSCMenu.config.controls.menu_up, 0),"Andare avanti"},
			{GetControlInstructionalButton(1,LSCMenu.config.controls.menu_down, 0),"Scendere"},
			{GetControlInstructionalButton(1,LSCMenu.config.controls.menu_left, 0),"Sinistra"},
			{GetControlInstructionalButton(1,LSCMenu.config.controls.menu_right, 0),"Destra"},
		},0)
		...
		LSCMenu:addSubMenu("categorie","categorie",nil,false)
		LSCMenu.categorie.buttons = {}
		local maxvehhp = 1000
		local damage = 0
		damage = (maxvehhp - GetVehicleBodyHealth(veh))/100
		LSCMenu:addPurchase("Riparare",round(250+150*damage,0),nil)
		...
		myveh.corxenon = GetVehicleHeadlightsColour(veh)
		myveh.mods = {}
		for i = 0, 48 do
		...
		local telaio,interior,bumper,fbumper,rbumper = false,false,false,false
		...
		AddMod(0,LSCMenu.categorie,"SPOILER","Spoiler",nil,true)
		AddMod(3,LSCMenu.categorie,"SKIRTS","Gonne",nil,true)
		AddMod(4,LSCMenu.categorie,"EXHAUST","Scarichi",nil,true)
		AddMod(6,LSCMenu.categorie,"GRILLE","Griglia",nil,true)
		AddMod(8,LSCMenu.categorie,"FENDERS","Parafanghi",nil,true)
		AddMod(10,LSCMenu.categorie,"ROOF","Tetto",nil,true)
		AddMod(12,LSCMenu.categorie,"BRAKES","Freni",nil,true)
		AddMod(13,LSCMenu.categorie,"TRANSMISSION","Trasmissioni",nil,true)
		AddMod(14,LSCMenu.categorie,"HORN", "Horn",nil,true)
		AddMod(15,LSCMenu.categorie,"SUSPENSION","Sospensioni",nil,true)
		AddMod(16,LSCMenu.categorie,"ARMOR","Armatura",nil,true)
		AddMod(18, LSCMenu.categorie,"TURBO","Turbo",nil,true)
		
		if telaio then
			LSCMenu.categorie:addSubMenu("TELAIO","Telaio",nil,true)
			AddMod(42, LSCMenu.categorie.Telaio,"ARCH COVER","Arch cover",nil,true)
			AddMod(43, LSCMenu.categorie.Telaio,"AERIALS","Aerials",nil,true)
			AddMod(44, LSCMenu.categorie.Telaio,"ROOF SCOOPS","Roof Scoops",nil,true)
			AddMod(45, LSCMenu.categorie.Telaio,"Tank","Tank",nil,true)
			AddMod(46, LSCMenu.categorie.Telaio,"DOORS","Doors",nil,true)
			AddMod(5,LSCMenu.categorie.Telaio,"ROLL CAGE","Roll cage",nil,true)
		end

		LSCMenu.categorie:addSubMenu("MOTORE","Motore",nil,true)
		AddMod(39, LSCMenu.categorie.Engine,"ENGINE BLOCK","Blocco motore",nil,true)
		AddMod(40, LSCMenu.categorie.Engine,"CAM COVER","Copertura della camma",nil,true)
		AddMod(41, LSCMenu.categorie.Engine,"STRUT BRACE","Tutore puntone",nil,true)
		AddMod(11,LSCMenu.categorie.Engine,"ENGINE TUNES","Motore Engine",nil,true)

		if interior then
			LSCMenu.categorie:addSubMenu("INTERIOR","Interior",nil,true)
			AddMod(27, LSCMenu.categorie.Interior,"TRIM DESIGN","Trim Design",nil,true)
			AddMod(28, LSCMenu.categorie.Interior,"ORNAMENTS","Ornaments",nil,true)
			AddMod(29, LSCMenu.categorie.Interior,"DASHBOARD","Dashboard",nil,true)
			AddMod(30, LSCMenu.categorie.Interior,"DIAL DESIGN","Dials",nil,true)
			AddMod(31, LSCMenu.categorie.Interior,"DOORS","Doors",nil,true)
			AddMod(32, LSCMenu.categorie.Interior,"SEATS","Seats",nil,true)
			AddMod(33, LSCMenu.categorie.Interior,"STEERING WHEELS","Steering Wheels",nil,true)
			AddMod(34, LSCMenu.categorie.Interior,"Shifter leavers","Shifter leavers",nil,true)
			AddMod(35, LSCMenu.categorie.Interior,"Plaques","Plaques",nil,true)
			AddMod(36, LSCMenu.categorie.Interior,"Speakers","Speakers",nil,true)
			AddMod(37, LSCMenu.categorie.Interior,"Trunk","Trunk",nil,true)
		end

		LSCMenu.categorie:addSubMenu("PLATES","Plates",nil,true)
		LSCMenu.categorie.Plates:addSubMenu("LICENSE","License",nil,true)
		for n, mod in pairs(LSC_Config.prices.plates) do
			local btn = LSCMenu.categorie.Plates.License:addPurchase(mod.name,mod.price)btn.plateindex = mod.plateindex
		end

		AddMod(25, LSCMenu.categorie.Plates,"Plate holder","Plate holder",nil,true)
		AddMod(26, LSCMenu.categorie.Plates,"Vanity plates","Vanity plates",nil,true)
		AddMod(38,LSCMenu.categorie,"HYDRAULICS","Hydraulics",nil,true)
		AddMod(48,LSCMenu.categorie,"Liveries","Liveries",nil,true)

		if bumper then
			LSCMenu.categorie:addSubMenu("BUMPERS","Bumpers",nil,true)
			if fbumper then
				AddMod(1,LSCMenu.categorie.Bumpers,"FRONT BUMPERS","Front bumpers",nil,true)
			end
			if rbumper then
				AddMod(2,LSCMenu.categorie.Bumpers,"REAR BUMPERS","Rear bumpers",nil,true)
			end
		end

		local m = LSCMenu.categorie:addSubMenu("LIGHTS","Lights",nil,true)
		AddMod(22,LSCMenu.categorie.Lights,"HEADLIGHTS","Headlights",nil,false)
		...
		respray = LSCMenu.categorie:addSubMenu("RESPRAY","Respray",nil,true)
		...
		LSCMenu.categorie:addSubMenu("WHEELS","Wheels",nil,true)
		wtype = LSCMenu.categorie.Wheels:addSubMenu("WHEEL TYPE","Wheel type",nil,true)
		if IsThisModelABike(GetEntityModel(veh)) then
			...
			bennysdw = wtype:addSubMenu("BENNYS WHEELS","Bennys",nil,true)
			for n,w in pairs(LSC_Config.prices.bennysweels) do
				local btn = bennysdw:addPurchase(w.name,w.price)btn.wtype = w.wtype btn.modtype = 23 btn.mod = w.mod
			end
			goldendw = wtype:addSubMenu("GOLDEN WHEELS","Golden",nil,true)
			for n,w in pairs(LSC_Config.prices.goldenweels) do
				local btn = goldendw:addPurchase(w.name,w.price)btn.wtype = w.wtype btn.modtype = 23 btn.mod = w.mod
			end
		end

		m = LSCMenu.categorie.Wheels:addSubMenu("WHEEL COLOR","Wheel color",nil,true)
		...
		m = LSCMenu.categorie.Wheels:addSubMenu("WHEEL ACCESSORIES","Wheel accessories",nil,true)
		...
		m = LSCMenu.categorie:addSubMenu("WINDOWS","Windows",nil,true)
		...
		CreateThread(function()
			...
			SetCamActive(cam,false)
				...
				LSCMenu:Open("categorie")

			FreezeEntityPosition(veh,true)
			disableControlsFunc(true)
		end)
	end
end

local function DriveInGarageAdmin()
	...
	if DoesEntityExist(veh) then
		LSCMenu:setTitle("Admin's Motorworks")
		LSCMenu.title_sprite = "shopui_title_supermod"
		...
		AddMod(0,LSCMenu.categorie,"SPOILER","Spoiler",nil,true)
		AddMod(3,LSCMenu.categorie,"SKIRTS","Skirts",nil,true)
		AddMod(4,LSCMenu.categorie,"EXHAUST","Exhausts",nil,true)
		AddMod(6,LSCMenu.categorie,"GRILLE","Grille",nil,true)
		AddMod(7,LSCMenu.categorie,"HOOD","Hood",nil,true)
		AddMod(8,LSCMenu.categorie,"FENDERS","Fenders",nil,true)
		AddMod(10,LSCMenu.categorie,"ROOF","Roof",nil,true)
		AddMod(12,LSCMenu.categorie,"BRAKES","Brakes",nil,true)
		AddMod(13,LSCMenu.categorie,"TRANSMISSION","Transmission",nil,true)
		AddMod(14,LSCMenu.categorie,"HORN", "Horn",nil,true)
		AddMod(15,LSCMenu.categorie,"SUSPENSION","Suspension",nil,true)
		AddMod(16,LSCMenu.categorie,"ARMOR","Armor",nil,true)
		AddMod(18, LSCMenu.categorie,"TURBO","Turbo",nil,true)
		...
		LSCMenu.categorie:addSubMenu("MOTORE","Motore",nil,true)
		AddMod(39, LSCMenu.categorie.Motore,"ENGINE BLOCK","Blocco motore",nil,true)
		AddMod(40, LSCMenu.categorie.Motore,"CAM COVER","Copertura della camma",nil,true)
		AddMod(41, LSCMenu.categorie.Motore,"STRUT BRACE","Tutore puntone",nil,true)
		AddMod(11,LSCMenu.categorie.Motore,"ENGINE TUNES","Motore Engine",nil,true)
		...
		-- LSCMenu.categorie:addSubMenu("RUSHER","Rusher",nil,true)
		LSCMenu.categorie.Lights:addSubMenu("RUSHER","Rusher",nil,true)
		for n, mod in pairs(LSC_Config.prices.coresXenon) do
			local btn = LSCMenu.categorie.Lights.Rusher:addPurchase(mod.name,mod.price)btn.corxenon = mod.corxenon
		end
...
--[[ 			SetEntityCoords(veh,pos.x,pos.y,pos.z,1,0,0,1)
		...
		CreateThread(function()
			local ped = PlayerPedId()
			local veh = GetVehiclePedIsUsing(ped)
			myveh.vfarol = GetVehicleXenonLightsColour(veh)
			TriggerServerEvent("LSC:finished",myveh)
				...
				if DoesEntityExist(veh) and GetPedInVehicleSeat(veh,-1) == ped and (IsThisModelACar(GetEntityModel(veh)) or IsThisModelABike(GetEntityModel(veh))) then
					for i,pos in ipairs(garages) do
						...
						if LSC_Config.oldenter then
							if GetDistanceBetweenCoords(outside.x,outside.y,outside.z,GetEntityCoords(ped)) <= f(3) then
								DelayThread = 5
								if not tableContains(LSC_Config.ModelBlacklist,GetDisplayNameFromVehicleModel(GetEntityModel(veh)):lower()) then
										...
										if not LSC_Config.lock then
											if IsControlJustPressed(1,38) then
												if emP.checkPermission() then
													...
													TriggerEvent("Notify","importante","Solo i <b>MECCANICI</b> può modificare i veicoli.")
												end
											else
												drawTxt("PREMI  ~p~[~w~E~p~]~w~  PER ACCEDERE ALLE MODIFICHE",4,0.5,0.93,0.50,255,255,255,180)
											end
										else
											drawTxt("~r~MECCANICO~w~ OCCUPATO AL MOMENTO",4,0.5,0.93,0.50,255,255,255,180)
										end
									else
										if IsControlJustPressed(1,38) then
											if emP.checkPermission() then
									...
									drawTxt("~p~MECCANICO~w~ OCCUPATO AL MOMENTO",4,0.5,0.93,0.50,255,255,255,180)
								end
							end
						else
...
local modoadm = false
RegisterCommand('bennysadm', function(source, args, rawCmd)
    
	if emP.checkAdmin() then
		inside = true
		DriveInGarageAdmin()
		modoadm = true
	end
...
function LSCMenu:onSelectedIndexChanged(name,button)
	...
	elseif m == "xenon color" then
		SetVehicleHeadlightsColour(veh,button.corxenon)
...
AddEventHandler("LSC:buttonSelected",function(name,button,canpurchase)
	...
	elseif mname == "sport" or mname == "muscle" or mname == "lowrider" or mname == "back wheel" or mname == "front wheel" or mname == "highend" or mname == "suv" or mname == "offroad" or mname == "tuner" or mname == "import" or mname == "bennys" or mname == "golden" then
		if button.purchased or CanPurchase(price, canpurchase) then
	...
	elseif mname == "xenon color" then
		if button.purchased or CanPurchase(price,canpurchase) then
			myveh.corxenon = button.corxenon
			SetVehicleHeadlightsColour(veh,button.corxenon)
		end
...
local function PointCamAtBone(bone,ox,oy,oz)
	SetIbuttons({
		{ GetControlInstructionalButton(1,LSCMenu.config.controls.menu_back, 0),"Indietro" },
		{ GetControlInstructionalButton(1,LSCMenu.config.controls.menu_select, 0),"Selezionare" },
		{ GetControlInstructionalButton(1,LSCMenu.config.controls.menu_up, 0),"Avanti" },
		{ GetControlInstructionalButton(1,LSCMenu.config.controls.menu_down, 0),"Scendere" },
		{ GetControlInstructionalButton(1,LSCMenu.config.controls.menu_left, 0),"Sinistra" },
		{ GetControlInstructionalButton(1,LSCMenu.config.controls.menu_right, 0),"Destra" },
...
function LSCMenu:OnMenuChange(last,current)
	...
	if last.name == "categorie" and current.name == "main" then
		LSCMenu:Close()
	end	
	...
	elseif c == "front wheel" or c == "wheel accessories" or  c == "wheel color" or c == "sport" or c == "muscle" or c == "lowrider"  or c == "highend" or c == "suv" or c == "offroad" or c == "tuner" or c == "import" or c == "bennys" or c == "golden" then
...
function CheckPurchases(m)
	...
	elseif name == "sport" or name == "muscle" or name == "lowrider" or name == "back wheel" or name == "front wheel" or name == "highend" or name == "suv" or name == "offroad" or name == "tuner" or name == "import" or name == "bennys" or name == "golden" then
		for i,b in pairs(m.buttons) do
	...
	elseif name == "corxenon" then
		for i,b in pairs(m.buttons) do
			if myveh.corxenon == b.corxenon then
				b.sprite = "garage"
			else
				b.sprite = nil
			end
...
function CanPurchase(price,canpurchase)
	if canpurchase then
		if LSCMenu.currentmenu == "main" then
			LSCMenu:showNotification("Riparato.")
		else
			TriggerEvent("Notify","successo","Modifiche applicate.")
		end
		return true
	end
end
