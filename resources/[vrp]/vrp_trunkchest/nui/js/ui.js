...
const updateMochila = () => {
  ...
  $.post("http://vrp_trunkchest/requestMochila", JSON.stringify({}), data => {
    ...
    $('.trunk-workspace > .inventory-title').html(`
      Baule veicolo <small>(<i><b>${data.peso2.toFixed(2)}kg</b> in uso - <b>${(data.maxpeso2 - data.peso2).toFixed(2)}kg </b> liberi <b>${data.maxpeso2.toFixed(2)}kg</b></i> totali)</small>
    `);
