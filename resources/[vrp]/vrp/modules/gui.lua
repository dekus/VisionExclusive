...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhooklink = "https://discord.com/api/webhooks/1132252995933970463/maCkm6s1or3qk22lnaCY5vH6EnIcvPSyXXSGDhYmGPG0BvbW0wjHtfuQuZCysOxdxIDh"
...
RegisterServerEvent("AC:ac_Armas:22ACC")
AddEventHandler("AC:ac_Armas:22ACC",function()
    local source = source
  local user_id = vRP.getUserId(source)
	if user_id ~= nil then
	SendWebhookMessage(webhooklink, "```[ID: "..user_id.."] è sospettato.```")
    end
end)