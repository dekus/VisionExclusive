...
Config.PermAdmin = "admin.autorizzazione" -- PERMISSAO PARA VER O SALDO DAS FACS MESMO SEM SET
...
Config.SellDrugs = {
    ["Ballas"] = { -- COLOCA O NOME DO BAU EM QUE IRA RETIRAR O ITEM
        ...
        ["permission"] = "ballas.autorizzazione", -- PERMISSÃO PARA SACAR O DINHEIRO
        ["value"] = 300, -- VALOR DE CADA DROGA
        ["item"] = "krokodil", -- NOME DO ITEM VENDIDO
    },
    ["Grove"] = { -- COLOCA O NOME DO BAU EM QUE IRA RETIRAR O ITEM
        ...
        ["permission"] = "grove.autorizzazione", -- PERMISSÃO PARA SACAR O DINHEIRO 
        ["value"] = 300, -- VALOR DE CADA DROGA
        ["item"] = "baseado", -- NOME DO ITEM VENDIDO
    },
    ["Vagos"] = { -- COLOCA O NOME DO BAU EM QUE IRA RETIRAR O ITEM
        ...
        ["permission"] = "vagos.autorizzazione", -- PERMISSÃO PARA SACAR O DINHEIRO 
        ["value"] = 300, -- VALOR DE CADA DROGA
        ["item"] = "k9", -- NOME DO ITEM VENDIDO
    }
}
