...
function handleStateBagInitilization(source)
    ...
    if not plyState.pmaVoiceInit then
        plyState:set('radio', GetConvarInt('voice_defaultRadioVolume', 200), true)
...
CreateThread(function()
    ...
    local radioVolume = GetConvarInt("voice_defaultRadioVolume", 200)
    ...
    then
        SetConvarReplicated("voice_defaultRadioVolume", 200)
